...
export default function ExamsPage() {
  ...
  const [viewingRoutine, setViewingRoutine] = useState<ExamRoutine | null>(null);
  ...
  const classGroups = classes
    .map(cls => ({
      ...
      label: cls,
      routines: examRoutines.filter((r) => r.className === cls),
    }))
  ...
  }, [examRoutines, classGroups.length]);
        ...
        <Card className="border-none shadow-xl">
          <CardHeader className="border-b bg-slate-50/50">
            <CardTitle className="text-2xl font-bold text-slate-900 flex items-center gap-2">
              ...
              Examination Schedules by Class Level
            </CardTitle>
            <p className="text-sm text-slate-600 mt-2">
              Select a class to view and download examination routines
            </p>
          </CardHeader>
          ...
          <CardContent className="p-6">
            {loading ? (
                        ...
                        <div className="relative">
                          ...
                          <div className="py-2 sm:py-3 bg-slate-100 px-3 sm:px-6 flex items-center justify-between">
                            ...
                            <Badge variant="outline" className="gap-1 text-xs sm:text-sm">
                              ...
                              <span className="hidden sm:inline">{viewingRoutine.examName}</span>
                            </Badge>
                          </div>
                      ...
                      <div>
                        <div className="mb-4">
                          <p className="text-sm text-slate-600">
                            Showing <strong>{group.routines.length}</strong> exam routine{group.routines.length !== 1 ? 's' : ''} for {group.label}
                          </p>
                        </div>
                                ...
                                <TableRow key={routine._id} className="hover:bg-slate-50">
                                  <TableCell>
                                    <div className="flex items-center gap-2 sm:gap-3">
                                      ...
                                      <div>
                                        <p className="font-medium text-slate-900 text-sm sm:text-base">{routine.examName}</p>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-slate-900 mb-2">No Exam Routines Available</h3>
                <p className="text-slate-600">
                  Exam routines will be posted here when available.
                </p>
              </div>
            )}
          </CardContent>
